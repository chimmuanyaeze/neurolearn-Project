...
class FullSolution(Scene):
    def construct(self):
        ...
        cue_obj = Text("Highlight the substitution of radius and height into the formula.", font_size=28, color=YELLOW).to_edge(DOWN)
        ...
        self.wait(0.5)
        body3 = Text("Now, calculate the volume: V = 160 * pi cubic meters. Using an approximate value of pi (3.14), we find V is about 502.4 cubic meters.", font_size=24).next_to(title3, DOWN)
        self.play(Write(body3))
        self.wait(1)
        
        cue_obj = Text("Show the calculation of volume using pi.", font_size=28, color=YELLOW).to_edge(DOWN)
        ...
        self.wait(0.5)
        body4 = Text("To convert cubic meters to liters, multiply by 1000 (since 1 cubic meter = 1000 liters). Thus, 502.4 cubic meters equals 502400 liters.", font_size=24).next_to(title4, DOWN)
        ...
        title5 = Text("Determine Fill Time in Seconds", font_size=36)
        self.play(Write(title5))
        self.wait(0.5)
        body5 = Text("Next, to find out how long it takes to fill the tank, divide the total volume in liters by the fill rate. So, 502400 liters divided by 20 liters per second equals 25120 seconds.", font_size=24).next_to(title5, DOWN)
        ...
        title6 = Text("Convert Fill Time to Minutes", font_size=36)
        self.play(Write(title6))
        self.wait(0.5)
        body6 = Text("To convert seconds to minutes, divide the total seconds by 60. Therefore, 25120 seconds divided by 60 equals approximately 418.67 minutes.", font_size=24).next_to(title6, DOWN)
        ...
        title7 = Text("Final Results", font_size=36)
        ...
        cue_obj = Text("Summarize the final results clearly.", font_size=28, color=YELLOW).to_edge(DOWN)
