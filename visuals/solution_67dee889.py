...
class FullSolution(Scene):
    def construct(self):
        ...
        self.wait(0.5)
        body1 = Text("The volume of a cylinder is calculated using the formula V = pi * r^2 * h. Here, r is the radius (4 meters) and h is the height (10 meters).", font_size=24).next_to(title1, DOWN)
        ...
        self.wait(0.5)
        body3 = Text("Now calculate V = pi * 160. Using approximately 3.14 for pi, the volume is about 502.4 cubic meters.", font_size=24).next_to(title3, DOWN)
        self.play(Write(body3))
        self.wait(1)
        
        cue_obj = Text("Show the calculation of the volume using pi.", font_size=28, color=YELLOW).to_edge(DOWN)
        ...
        self.wait(0.5)
        body4 = Text("Since 1 cubic meter equals 1000 liters, multiply the volume in cubic meters by 1000. Therefore, 502.4 cubic meters is 502400 liters.", font_size=24).next_to(title4, DOWN)
        ...
        self.wait(0.5)
        body5 = Text("To find out how long it takes to fill the tank, divide the total volume (502400 liters) by the fill rate (20 liters per second). This gives 25120 seconds.", font_size=24).next_to(title5, DOWN)
        ...
        self.wait(0.5)
        body6 = Text("To convert seconds to minutes, divide the total seconds (25120) by 60. This results in approximately 418.67 minutes.", font_size=24).next_to(title6, DOWN)
